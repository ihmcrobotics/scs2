...
public class SessionVisualizerMessagerAPI
{
   ...
   private static final CategoryTheme HeightScan = apiFactory.createCategoryTheme("HeightScan");
   ...
   public static final Topic<Boolean> ShowHeightScan = APIRoot.child(Perception).child(HeightScan).topic(Show);
