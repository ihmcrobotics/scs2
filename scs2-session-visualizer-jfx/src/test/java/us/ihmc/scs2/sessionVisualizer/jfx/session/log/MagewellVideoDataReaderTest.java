...
public class MagewellVideoDataReaderTest
{
   ...
   /**
    * Regression test for the reused-image overload: {@link MagewellVideoDataReader} (via its
   ...
   void convertFrameToWritableImageReusesACorrectlySizedImage()
   {
      ...
      WritableImage result = MagewellVideoDataReader.convertFrameToWritableImage(frame, imageToReuse);
   ...
   void convertFrameToWritableImageAllocatesWhenTheSizeDoesNotMatch()
   {
      ...
      WritableImage result = MagewellVideoDataReader.convertFrameToWritableImage(frame, wrongSize);
   ...
   void convertFrameToWritableImageReuseIsFasterThanReallocating()
   {
      ...
      for (int i = 0; i < WARMUP_ITERATIONS; i++)
      {
         MagewellVideoDataReader.convertFrameToWritableImage(frame, reused);
      }
