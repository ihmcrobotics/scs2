...
/**
 * Reads video and depth data from one or more ZED SDK SVO2 files recorded during the log.
 */
public class ZEDSVODepthScrubber
{
   ...
   public ZEDSVODepthScrubber(File timestampsDatFile)
   {
   ...
   public void scrub(long timestamp)
   {
      ...
      if (svoFile == null)
      {
         ...
         initParameters.depth_mode(SL_DEPTH_MODE_PERFORMANCE);
