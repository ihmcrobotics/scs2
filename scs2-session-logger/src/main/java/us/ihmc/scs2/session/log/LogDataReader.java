...
>>>>>>> e787d8f6 (Stuff)
      ...
      if (compressed)
      {
         ...
         int storedBatchSize = (int) logProperties.getVariables().getCompressionBatchSize();
         ...
         if (batchSize > 1)
         {
            int storedValidTicksInLastBatch = (int) logProperties.getVariables().getValidTicksInLastBatch();
